...
export function DataTable({ data, columns, onRowClick = undefined, onEdit = undefined, onDelete = undefined, onAdd = undefined, addButtonText = "Adicionar", emptyMessage = "Nenhum registro encontrado", emptyDescription = "Adicione itens para começar a visualizar dados aqui" }) {
  return (
